...
// Module-level singleton — created once per cold start, reused across all requests
// in the same function instance. Avoids object construction overhead per call.
const client = new Anthropic({ apiKey: process.env.ANTHROPIC_API_KEY })

export async function callClaude(userMessage, personaId = 'general', history = []) {
