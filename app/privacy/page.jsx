    ...
    <div>
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '48px 24px 64px' }}>
        ...
        <div style={SECTION_STYLE}>
          ...
          <p style={P_STYLE}>
            To exercise any of these rights, email us at <a href="mailto:admin.nomadvital@gmail.com" style={{ color: '#1D9E75', textDecoration: 'underline' }}>admin.nomadvital@gmail.com</a>. We will respond within 30 days.
          </p>
        </div>
