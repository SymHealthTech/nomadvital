  ...
  return (
    <div className="bg-[#0F6E56] py-4 border-y border-[#085041]">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-wrap items-center justify-center gap-0 divide-x divide-[#085041]">
          {/* Item 1 */}
          ...
          {/* Item 4 — Country pills */}
          <div className="flex items-center gap-2 px-4 py-2 text-white text-sm flex-wrap">
            <span className="text-[#9FE1CB]">Including</span>
            <div className="flex flex-wrap gap-1">
              {countries.map((c) => (
                <span
                  key={c}
                  className="bg-[#085041] text-[#9FE1CB] text-xs px-2 py-0.5 rounded-full font-medium"
                >
                  {c}
                </span>
              ))}
              <span className="bg-[#085041] text-[#9FE1CB] text-xs px-2 py-0.5 rounded-full font-medium">
                +more
              </span>
            </div>
          </div>
